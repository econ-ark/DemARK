...
if docker exec -it ee2179993603 pgrep -f jupyter-lab > /dev/null 2>&1; then
    ...
    echo "========================"
    echo ""
    echo "The container is running Jupyter Lab on port 8890."
    echo "To access it from your browser, you need to forward the port."
    echo ""
    echo "Run this command in a NEW terminal window:"
    echo ""
    echo "  docker exec -it ee2179993603 socat TCP-LISTEN:8890,fork TCP:localhost:8890"
    echo ""
