...
file_path=os.path.join(HARK.__path__[0], 'cstwMPC', 'USactuarial.txt')
f = open(file_path,'r')
...
file_path=os.path.join(HARK.__path__[0], 'cstwMPC', 'EducMortAdj.txt')
f = open(file_path,'r')
...
file_path=os.path.join(HARK.__path__[0], 'cstwMPC', SCF_data_file)
f = open(file_path,'r')
